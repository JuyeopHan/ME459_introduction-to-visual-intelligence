...
# Parameters
num_disp_values=65536 # these images have disparity between 0 and 15.
Lambda=10.0
nb_iterations=60
...
def stereo_bp(I1,I2,num_disp_values,Lambda,Tau=15,num_iterations=20):
    """The main function"""
...
if __name__ == '__main__':
    ...
    img_left =imageio.imread('./StereoImages/00000_ref.png')
    img_right=imageio.imread('./StereoImages/00000_tar.png')
    plt.subplot(121)
    plt.imshow(img_left)
    plt.subplot(122)
